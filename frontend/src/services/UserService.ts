...
export default class UserService {
    ...
    static async getAllBanks(): Promise<AxiosResponse<OrdersResponse>> {
        return $api.get(`/utils/banks`)
    }

    static async getAllCurrencies(): Promise<AxiosResponse<OrdersResponse>> {
        return $api.get(`/utils/currencies`)
    }
    ...
    static async deleteOrder(orderId: number): Promise<AxiosResponse<OrdersResponse>> {
        return $api.post(`/orders/delete/${orderId}`)
    }
