...
const ResponseDetailsCancelled = ({response, statusHandler, isSell, responseTimer}) => {
    ...
    return (
        <div className="card shadow-sm border-danger">
            <div className="card-body text-center p-4">
                ...
                <h3 className="mb-3">Сделка отменена</h3>
                ...
                <div className="d-grid gap-2 mx-auto mt-4" style={{maxWidth: '400px'}}>
                    <Link className="btn btn-outline-secondary" to={"/orders-history"}>
...
export default observer(ResponseDetailsCancelled)