...
@Component
public class DisputedNotificationStrategy implements NotificationStrategy{
    @Override
    public NotificationCreationDTO createNotification(OrderResponse response) {
        ...
        notification.setMessage("Объявление № " + response.getId() + "было отправлено на разбирательство");
